...
# Usage
Webシステム機能一覧
1.SEIYA OZAWAポートフォーリオページ（リスポンシブ対応）:特になし

2.東三河幸せ宅配便サイト（indexページのみリスポンシブ対応）:1メインビジュアルスライダー機能,2twitterによる商品紹介機能,3人気商品ランキング機能,4会員登録・ログイン・ログアウト・削除機能,5お問い合わせ機能,6買い物かご・商品数量変更・削除機能,7商品配達日時指定機能,8クレジットカード情報入力機能,9注文完了メール自動送信機能
