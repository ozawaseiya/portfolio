...
<head>
	<meta charset="UTF-8N">
	<title>東三河幸せ宅配便管理トップメニュー</title>
	<link href="adminBranch.css" rel="stylesheet" type="text/css">
</head>
...
<body>
	...
	<div id="contents">
		<div id="mainTitle">
			<p>東三河幸せ宅配便管理トップメニュー</p>
		</div>
		<div id="branchBox">
			<a href="staff/staffList.php">管理者情報一覧</a><br/>
			<a href="memberData/memberList/memberList.php">会員登録一覧</a>
			<br/>
			<a href="inquiryData/inquiryList/inquiryList.php">お問い合わせ一覧</a>
			<br/>
			<a href="productData/productList/productList.php">商品管理情報一覧</a>
			<br/>
			<a href="orderData/orderList/orderList.php">注文管理情報一覧</a><br/>
			<a href="staffLogin/staffLogout.php">ログアウト</a><br/>
		</div>
	</div>
	<footer>
	</footer>
