...
<!-- End Google Tag Manager -->
	<meta charset="UTF-8N">
	<title>ドリンク</title>
	<link href="1style6.css" rel="stylesheet" type="text/css">
	<link href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/css/lightbox.css" rel="stylesheet">
	<script src="https://code.jquery.com/jquery-1.12.4.min.js" type="text/javascript"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/js/lightbox.min.js" type="text/javascript"></script>
	<script src="1script6.js"></script>
</head>
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div id="contents">
		...
		<div id="sub1">
			<div id="productPicture"><a href="../common/toyonesodabig.jpg" data-lightbox="abc" data-title="拡大画像（右側の×ボタンをクリックすると戻ります）"><img src="../common/toyonesoda.jpg" alt="豊根サイダー">
</a>
			</div>
			...
			<div id="counterZone">
				...
				print '</select>個';
				print '<input type="hidden" name="code" value="5">';
		...
		<section>
			...
			<table>
				...
				<tr>
					<th>商品紹介</th>
					<td>:豊根の天然水を使用し、人工甘味料を一切使わない爽快感のあるサイダーに仕上げ</td>
				</tr>
				<tr>
					<th>原材料名</th>
					<td>:砂糖類（果糖ぶどう糖液糖、砂糖）、炭酸、香料、酸味料、天然水</td>
				</tr>
				<tr>
					<th>栄養成分表示</th>
					<td>:100mlあたりエネルギー：42kcal、たんぱく質：0g、脂質：0g、炭水化物：11g、ナトリウム：3-13mg</td>
				</tr>
			</table>
		</section>
	</div>
