...
<!-- End Google Tag Manager -->
	<meta charset="UTF-8N">
	<title>ドリンク</title>
	<link href="1style5.css" rel="stylesheet" type="text/css">
	<link href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/css/lightbox.css" rel="stylesheet">
	<script src="https://code.jquery.com/jquery-1.12.4.min.js" type="text/javascript"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/js/lightbox.min.js" type="text/javascript"></script>
	<script src="1script5.js"></script>
</head>
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div id="contents">
		...
		<div id="sub1">
			<div id="productPicture"><a href="../common/gamagorimikanjuicebig.jpg" data-lightbox="abc" data-title="拡大画像（右側の×ボタンをクリックすると戻ります）"><img src="../common/gamagorimikanjuice.jpg" alt="蒲郡みかんジュース">
</a>
			</div>
			...
			<div id="counterZone">
				...
				print '</select>個';
				print '<input type="hidden" name="code" value="4">';
		...
		<section>
			...
			<table>
				...
				<tr>
					<th>商品紹介</th>
					<td>:さっぱりした味わいが子供からお年寄りまで幅広い世代から支持されている昔ながらのジュースです。</td>
				</tr>
				<tr>
					<th>原材料名</th>
					<td>:蒲郡みかん</td>
				...
				<tr>
					<th>栄養成分表示</th>
					<td>:栄養成分表示/100ml当たり：エネルギー 41kcal、たんぱく質 0.5g、脂質 0g、炭水化物 9.8g、ナトリウム 4mg</td>
				</tr>
			</table>
		</section>
	</div>
