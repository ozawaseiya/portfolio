...
<body> 
	...
	<div id="contents">
		...
		<div id="sub1">
			<div id="productPicture"><a href="../common/okazakimisobig.jpg" data-lightbox="abc" data-title="拡大画像（右側の×ボタンをクリックすると戻ります）"><img src="../common/okazakimiso.jpg" alt="岡崎味噌まんじゅう">
</a>
			</div>
			...
			<div id="counterZone">
				...
				print '</select>個';
				print '<input type="hidden" name="code" value="2">';
		...
		<section>
			...
			<table>
				...
				<tr>
					<th>商品紹介</th>
					<td>:もっちりとした食感の生地でつつまれた餡とほんのり香る岡崎八丁味噌が絶妙なバランスの一品 です。
					</td>
				</tr>
				<tr>
					<th>原材料名</th>
					<td>:砂糖、小豆、小麦粉、いんげん豆、でん粉、八丁味噌、オリゴ糖、醤油、はちみつ、寒天、片栗粉、寒天、トレハロース、重曹、着色料</td>
				</tr>
				<tr>
					<th>栄養成分表示</th>
					<td>:1個あたりエネルギー：205kcal、たんぱく質：4.8g、脂質：2.2g、炭水化物：56g、ナトリウム：42mg</td>
				</tr>
			</table>
		</section>
	</div>
