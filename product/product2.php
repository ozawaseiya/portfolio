...
<!-- End Google Tag Manager -->
	<meta charset="UTF-8N">
	<title>和菓子・洋菓子</title>
	<link href="1style2.css" rel="stylesheet" type="text/css">
	<link href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/css/lightbox.css" rel="stylesheet">
	<script src="https://code.jquery.com/jquery-1.12.4.min.js" type="text/javascript"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/js/lightbox.min.js" type="text/javascript"></script>
	<script src="1script2.js"></script>
</head>
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div id="contents">
		...
		<div id="sub1">
			<div id="productPicture"><a href="../common/chokodobig.jpg" data-lightbox="abc" data-title="拡大画像（右側の×ボタンをクリックすると戻ります）"><img src="../common/chokodo.jpg" alt="チョコドー">
</a>
			</div>
			...
			<div id="counterZone">
				...
				print '</select>個';
				print '<input type="hidden" name="code" value="1">';
		...
		<section>
			...
			<table>
				...
				<tr>
					<th>商品紹介</th>
					<td>:有楽スイーツのオールドファッションドーナツと人気のブラックサンダーズが組み合わさり、ほろ苦い味わいとサクサクとした食感のドーナツです。</td>
				</tr>
				<tr>
					<th>原材料名</th>
					<td>:小麦粉、植物油脂、砂糖、卵、コーンフラワー、卵黄粉、全卵粉、植物性たんぱく、乳糖、脱脂粉乳、ホエイパウダー、食塩、バター、ベーキングパウダー、乳化剤、カゼインNa、酸化防止剤（ビタミンE)</td>
				</tr>
				<tr>
					<th>栄養成分表示</th>
					<td>:1個あたりエネルギー：225kcal、たんぱく質：2.8g、脂質：11.2g、炭水化物22g、ナトリウム：118mg、食塩:10.3gmg</td>
				</tr>
			</table>
		</section>
	</div>
