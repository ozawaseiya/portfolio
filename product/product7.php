...
<!-- End Google Tag Manager -->
	<meta charset="UTF-8N">
	<title>ドリンク</title>
	<link href="1style7.css" rel="stylesheet" type="text/css">
	<link href="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/css/lightbox.css" rel="stylesheet">
	<script src="https://code.jquery.com/jquery-1.12.4.min.js" type="text/javascript"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.7.1/js/lightbox.min.js" type="text/javascript"></script>
	<script src="1script7.js"></script>
</head>
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div id="contents">
		...
		<div id="sub1">
			<div id="productPicture"><a href="../common/shinshirokenkojuicebig.jpg" data-lightbox="abc" data-title="拡大画像（右側の×ボタンをクリックすると戻ります）"><img src="../common/shinshirokenkojuice.jpg" alt="新城健康ジュース">
</a>
			</div>
			...
			<div id="counterZone">
				...
				print '</select>個';
				print '<input type="hidden" name="code" value="6">';
		...
		<section>
			...
			<table>
				...
				<tr>
					<th>商品紹介</th>
					<td>:新城の19種類の野菜と3種類の果物をミックスしたあっさりとした飲みやすいジュースです。 この１本で１日に必要な野菜摂取量を摂取することができます。
					</td>
				</tr>
				<tr>
					<th>原材料名</th>
					<td>:野菜(にんじん、ピーマン、かぼちゃ、とうもろこし、たまねぎ、紫キャベツ、キャベツ、なす 、アスパラガス、セロリ、はくさい、だいこん、ケール、レタス、クレソン、ほうれん草、パセリ、ビート、あしたば)、果実(りんご、レモン、バナナ)、香料、ビタミンC
					</td>
				</tr>
				<tr>
					<th>栄養成分表示</th>
					<td>:コップ1杯(180g)あたり：エネルギー 35kcal、たんぱく質 0.9-2.4g、脂質 0g、糖質 6.4g、食物繊維 0.7-1.9g、ナトリウム 3-43mg、カリウム 440mg、カルシウム 3-37mg、ショ糖 0.2-0.6g、ビタミンK 4μg</td>
				</tr>
			</table>
		</section>
	</div>
